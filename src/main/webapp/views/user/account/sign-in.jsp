...
<head>
    <meta charset="UTF-8">
    <title>SignIn Online Entertainment</title>
    <!-- Font Awesome -->
                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    ...
                    <form action="<c:url value = "/account/sign-in"/>" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <input type="text" id="username" name="username" value="${username }" class="form-control form-control-lg" />
                       ...
                       <div class="d-flex justify-content-around align-items-center mb-4">
                        	<a href="<c:url value = "/account/sign-up"/>">SignUp</a>
                            <a href="<c:url value = "/account/forgot-password"/>">Forgot password?</a>
                        </div>
    				...
    				<center>
    					<div class="fb-login-button" onlogin="checkLoginState();" data-width="" data-size="large" data-button-type="login_with" data-layout="default" ></div>
    				</center>
