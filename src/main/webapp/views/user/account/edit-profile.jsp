...
<body>
	...
	<div class="container" style="margin-top: 58px">
		...
		<form class="col-md-6 m-auto" action="<c:url value = "/account/edit-profile"/>" method="post">
			<!-- ID input -->
			<div class="form-outline mb-4 ">
				<input type="text" id="id" class="form-control text-light "
					value="${sessionScope.user.id }"/>
				<label class="form-label text-light " for="id">User
					ID</label>
			</div>
			...
			<div class="form-outline mb-4">
				<input type="text" id="fullname" name="fullname"
					class="form-control text-light " value="${sessionScope.user.fullname }" /> <label
			...
			<div class="form-outline mb-4">
				<input type="email" id="email" name="email" class="form-control text-light "
					value="${sessionScope.user.email }" /> <label class="form-label text-light " for="email">Email</label>
			</div>
