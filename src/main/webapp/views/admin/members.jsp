...
<body>
	...
	<div class="container pt-4">
		...
		<form action="/dashboard/members" method="post">
			...
			<!-- Submit button -->
			<button class="btn btn-primary" formaction="dashboard/members/create">
				Create</button>
			<button class="btn btn-secondary" formaction="dashboard/members/update">Update</button>
			<button class="btn btn-danger" formaction="dashboard/members/delete">Delete</button>
			<button class="btn btn-success" formaction="dashboard/members/reset">Reset</button>
		</form>
			...
			<c:forEach var="item" items="${users }">
				<tbody>
					<tr>
						...
						<td><a href="dashboard/members/edit?id=<c:out value="${item.id}"/>">Edit</a>
							<a href="dashboard/members/delete?id=<c:out value="${item.id}"/>">Delete</a>
						</td>
					</tr>
				</tbody>
			</c:forEach>
